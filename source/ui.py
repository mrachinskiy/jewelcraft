...
class VIEW3D_MT_jewelcraft(Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("object.jewelcraft_prongs_auto_add", text="Auto Place Prongs", icon_value=icon_menu("PRONGS"))
...
class VIEW3D_PT_jewelcraft_jeweling(SidebarSetup, Panel):
    ...
    def draw(self, context):
        ...
        col.operator("object.jewelcraft_prongs_auto_add", text="Auto Place Prongs", icon_value=icon("PRONGS"))
