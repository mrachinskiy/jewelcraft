...
class OBJECT_OT_adjust_size(Operator):
    ...
    def execute(self, context):
        ...
        current_size = obj.dimensions.to_tuple()[0]
        ...
        pivot = obj.matrix_world.translation.to_tuple()
        bpy.ops.transform.resize(value=(scale, scale, scale), center_override=pivot)
