...
classes = (
    ...
    preferences.GemColor,
    preferences.WeightingMaterial,
    preferences.WeightingListItem,
    preferences.AssetLib,
    preferences.SizeItem,
    preferences.GemColorsList,
    preferences.MeasurementsList,
    preferences.MetadataList,
    preferences.WeightingMaterialsList,
    preferences.AssetLibsList,
    preferences.SizeList,
    preferences.Preferences,
    preferences.WmProperties,
    preferences.SceneProperties,
    ui.VIEW3D_UL_jewelcraft_gem_colors,
