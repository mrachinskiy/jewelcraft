...
_ru = {
    "*": {
        ...
        "Precious Alloys": "Драгоценные сплавы",
        "Precious Alloys RU (ГОСТ 30649-99)": "Драгоценные сплавы RU (ГОСТ 30649-99)",
        "Base Alloys": "Недрагоценные сплавы",
        "Sizes": "Размеры",
        "Prongs": "Крапана",
        "Cutter": "Выборка",
        ...
        "Display weight and volume for active mesh object": "Показать вес и объём для активного mesh объекта",
